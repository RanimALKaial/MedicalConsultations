<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DataMinningPage.aspx.cs" Inherits="MedicalConsultation.DataMinningPage" %>

<!DOCTYPE html>

<html>
<head>
<title>Online Bayes Classifier</title>
...
<div class="header">
	...
	<div class="banner text-center" style="background-image:url(..\\Patient\\images\\medical-doctor-stethoscope-and-office-sign-web-header.jpg);height: 250px;">
	  <div class="container">    
			...
			<p style="color: #5f85c6;">شاهد نتيجتك باستحدام خوارزمية التصنيف بايس</p>
	  </div>
	</div>
    <br />
    <br />
...
<label class="styled-select">
         ...
         <asp:DropDownList ID ="DropDownList1" runat="server" class="form-control">
             ...
             <asp:ListItem Text=" تضخم البطين الأيسر" Value="2"></asp:ListItem>
             <asp:ListItem Text="ST-Tشذوذ موجة" Value="3"></asp:ListItem>
    </asp:DropDownList>
</label>
       </div>
          </div>
    ...
    <asp:TextBox ID="t3" runat="server" class="form-control" placeholder="أقصى معدل ضربات قلبك" type="text" ></asp:TextBox>
                    ...
                    <div class="form-group">
                        <label  class="col-sm-2 control-label">تكرار الذبحة الصدرية</label>
                            <div class="col-sm-4">
...
<label class="styled-select">
    ...
    <asp:Label ID ="l1" runat ="server" ForeColor="#064686" Text="" style="font-size: 16px;font-weight: bold;"></asp:Label>
                    ...
                    <div class="form-group">
                            <div class="col-md-10">
                        <asp:Button  ID="Button1" runat="server" class="btn" Text="أظهر التقيم" OnClick="Button1_Click" style="margin-left: 21%;width: 100px;background-color: #5fad6d;color: white;"/>
