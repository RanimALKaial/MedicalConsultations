<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientHome.aspx.cs" Inherits="MedicalConsultation.Patient.PatientHome" %>
...
<div class="col-md-10 maincontent" >
    ...
    <div class="panel panel-default contentinside">
        <div class="panel-heading" dir="rtl"> قائمة الاستشارات</div>
...
<asp:Repeater ID="rbr" runat="server">
      ...
      <div id="doctorlist" class="switchgroup">
                   ...
                   <tr>
                           ...
                           <td><%#Eval("Counseling") %> <a href="ViewReplay.aspx?id=<%#Eval("id") %>">Read more</a></td>
                           <td><%#Eval("Counseling_date") %></td>
                           <td><img src="images/<%#Eval("image_path") %>" style="width:100px;height:100px"></td>
                           <td><%#Eval("replay") %></td>
                           
                           <td>
                            <a  href="ViewReplay.aspx?id=<%#Eval("id") %>" class="btn btn-primary" ><span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span></a>
