<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddMedicaltopics.aspx.cs" Inherits="MedicalConsultation.Doctor.AdminHome" %>
...
<div class="col-md-10 maincontent" >
    ...
    <div class="panel panel-default contentinside">
        <div class="panel-heading">Add Medical topics</div>
                       ...
                       <div class="panel-body">
                           <form  id="f2" runat="server"  class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <asp:TextBox ID="t1" runat="server" type="text" class="form-control"  placeholder="Title"></asp:TextBox>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <asp:FileUpload ID="f4" runat="server" class="form-control" />
                                    <%--<textarea id="t2" runat="server"  class="form-control"></textarea>--%>
                                </div>
                             </div>

                            <div class="form-group">
                                <label class="col-sm-4 control-label">Image topic</label>
                                <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-4 col-sm-10">
                                    <asp:Button ID="b1" runat="server" class="btn btn-primary" Text="Add Medical topic" OnClick="b1_Click" />
