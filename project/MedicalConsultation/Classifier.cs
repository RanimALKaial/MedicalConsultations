...
namespace MedicalConsultation
{
    public class Classifier
    {
        ...
        public double maxOne;
        public DataTable primaryData = new DataTable();
        ...
        public string Classify(double[] obj)
        {
            ...
            for (int i = 0; i < results.Count; i++)
            {
                ...
                primaryData.Rows.Add(results[i].Name, finalScore * 0.5);

            }

            //اختبار اكبر قيمة احتمال للاصابة بالمرض
            maxOne = score.Max(c => c.Value);
             name = (from c in score
        ...
        // ميثود خاصة بتحويل السطر الىIEnumerable 
