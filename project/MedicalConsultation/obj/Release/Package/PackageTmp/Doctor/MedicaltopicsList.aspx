<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MedicaltopicsList.aspx.cs" Inherits="MedicalConsultation.Doctor.MedicaltopicsList" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                ...
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">Medical topics List</div>
                                        ...
                                        <asp:Repeater ID="rbr" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td><%#Eval("views") %></td>
                                                    <td>
                                                        <img src="../Doctor/images/<%#Eval("imagepath") %>" class="thub" />
                                                    </td>
                                                    <td>
                                                        <a href="deleteTopic.aspx?id=<%#Eval("id") %>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
