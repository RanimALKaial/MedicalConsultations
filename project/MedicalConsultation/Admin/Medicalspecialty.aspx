<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Medicalspecialty.aspx.cs" Inherits="MedicalConsultation.Admin.Medicalspecialty" %>
        ...
        <div class="row">
            ...
            <div class="col-md-10 maincontent">
                ...
                <div class="panel panel-default contentinside">
                    <div class="panel-heading">Medical specialty List</div>
                                        ...
                                        <asp:Repeater ID="rbr" runat="server">
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="deletesep.aspx?id=<%#Eval("s_id") %>" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
